...
if (!empty($id_string)) {
    ...
    $cart_hash = md5($id_string);
        $cached_products = get_cached_query_result($conn, $sql, $types, $product_ids,     foreach ($cached_products as $item) {
    ...
    <main class="main-content">
        ...
        if ($recommendation_category) {
            ...
            $params = array_merge([$safe_category], $product_ids);
                        $recommended_array = get_cached_query_result($conn, $rec_sql, $types, $params, 
